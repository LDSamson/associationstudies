## Functions that I will phase out are in this R file
...
#' Note: deprecated function. Can be replaced by the association_study_long function
...
#' Note: deprecated function. Can be replaced by test_association
#'
